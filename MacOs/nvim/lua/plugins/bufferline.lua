return {
    ...
    vim.keymap.set('n', '[b', '<cmd>BufferLineCycleNext<CR>', {silent = true, noremap = true, desc = 'Cycle to next buffer'})
    vim.keymap.set('n', 'b]', '<cmd>BufferLineCyclePrev<CR>', {silent = true, noremap = true, desc = 'Cycle to previous buffer'})
    end,
}
